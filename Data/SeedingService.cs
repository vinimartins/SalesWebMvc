...
namespace SalesWebMvc.Data
    ...
    public class SeedingService
        ...
        public void Seed ( )
            ...
            Department d3 = new Department ( 3, "Bots" );
            Department d4 = new Department ( 4, "Books" );

            Seller s1 = new Seller ( 1, "Vinicius Manara", "vini.manara@eaglle.com.br", new DateTime ( 1995, 3, 01 ), 1000.0, d1 );
            Seller s2 = new Seller ( 2, "José Manara", "manara@eaglle.com.br", new DateTime ( 1995, 3, 01 ), 1000.0, d2 );
            Seller s3 = new Seller ( 3, "Maria Manara", "vnara@eaglle.com.br", new DateTime ( 1995, 3, 01 ), 1000.0, d3 );
            Seller s4 = new Seller ( 4, "Henrique Manara", "hmanara@eaglle.com.br", new DateTime ( 1995, 3, 01 ), 1000.0, d4 );
            Seller s5 = new Seller ( 5, "Joao Manara", "jmanara@eaglle.com.br", new DateTime ( 1995, 3, 01 ), 1000.0, d4 );
